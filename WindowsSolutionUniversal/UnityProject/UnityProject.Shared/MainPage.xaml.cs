    ...
    public sealed partial class MainPage : Page
    {
        ...
        void UpdateLiveTiles()
        {
            try
            {
                ...
                string frontMediumImagePath = "/Assets/MediumTile.png";
                ...
                XmlDocument frontMediumTemplate = TileUpdateManager.GetTemplateContent(TileTemplateType.TileSquare150x150PeekImageAndText01);
                XmlDocument frontWideTemplate = TileUpdateManager.GetTemplateContent(TileTemplateType.TileWide310x150PeekImage02);
                ...
                XmlNodeList mediumTextList = frontMediumTemplate.GetElementsByTagName("text");
                XmlNodeList wideTextList = frontWideTemplate.GetElementsByTagName("text");
